...
if __name__=="__main__":
    ...
    #gameBoards, bestMove, expandedNodes, bestValue, winner=uttt.playGamePredifinedAgent(True,True,True) #return gameBoards, bestMove, expandedNodes, bestValue, winner
